...
static verbosity _korali_verbosity;

static void koraliLog(const verbosity level, const char* format, ... )
{
...
static void koraliWarning(const verbosity level, const char* format, ... )
{
...
static void koraliError(const char* format, ... )
{
