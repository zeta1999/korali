...
#Nested run method
  ...
  def run_nested_with_termination_criterion(criterion, value) :
                                            ...
                                            print("[Korali] Prepare Nested run with Termination Criteria "
                                                  ...
                                                  e["Solver"]["Type"] = "Nested" e["Solver"]["Number Live Points"] = 1500 e["Solver"]["Batch Size"] = 1 e["Solver"]["Add Live Points"] = True e["Solver"]["Resampling Method"] = "Box" e["Solver"]["Termination Criteria"][criterion] = value
                                                    ...
                                                    k = korali.Engine()
                                                                        k.run(e)
                                                                          ...
                                                                          if (criterion == "Max Generations") : assert_value(e["Current Generation"], value)
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    elif (criterion == "Max Effective Sample Size") : assert_greatereq(e["Solver"]["Effective Sample Size"], value)
