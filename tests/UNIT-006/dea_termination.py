  ...
  def run_dea_with_termination_criterion(criterion, value) :
                                         ...
                                         print("[Korali] Prepare DEA run with Termination Criteria "
                                               "'{0}'".format(criterion))
                                                 ...
                                                 e = korali.Experiment()
                                                   e["Problem"]["Type"] = "Optimization/Stochastic" e["Problem"]["Objective Function"] = evaluateModel

                                               e["Variables"][0]["Name"] = "X" e["Variables"][0]["Lower Bound"] = + 1.0 e["Variables"][0]["Upper Bound"] = + 10.0

                                               e["Solver"]["Type"] = "DEA" e["Solver"]["Population Size"] = 10 e["Solver"]["Termination Criteria"][criterion] = value
                                                 ...
                                                 k = korali.Engine()
                                                                     k.run(e)
                                                                       ...
                                                                       if (criterion == "Max Generations") : assert_value(e["Current Generation"], value)
                                                                                                                            ...
                                                                                                                            elif (criterion == "Max Infeasible Resamplings") : assert_greatereq(e["Solver"]["Infeasible Sample Count"], value)

                                                                                                                                                                                                  elif (criterion == "Max Value") : assert_greatereq(e["Solver"]["Best Ever Value"], value)

                                                                                                                                                                                                                                                       elif (criterion == "Min Value Difference Threshold") : previous = e["Solver"]["Previous Best Ever Value"] current = e["Solver"]["Best Ever Value"] assert_smallereq(previous - current, value)
