...
src_py  = "../tutorials/a2-sampling/python/_result_run-mcmc/"
src_cxx = "../tutorials/a2-sampling/cxx/_result_run-mcmc/"
...
checkStd(json_cxx, 1.0, 0.2)

# Check python results
checkMean(json_py, 0.0, 0.05)
checkStd(json_py, 1.0, 0.2)
