...
Korali::Variable::Variable(nlohmann::json& js)
{
 setConfiguration(js);
}
...
nlohmann::json Korali::Variable::getConfiguration()
{
...
void Korali::Variable::initialize()
{
...
void Korali::Variable::printDetails()
{
 if (_distributionType = KoraliUniformDistribution) printf("Uniform(%.3g,%.3g)", _a, _b);
