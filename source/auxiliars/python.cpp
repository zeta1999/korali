...
#include "modules/conduits/mpi/mpi.hpp"
...
PYBIND11_MODULE(libkorali, m)
{
 ...
 pybind11::class_<Korali::KoraliJsonWrapper>(m, "__KoraliJsonWrapper")
   ...
   .def("__setitem__", pybind11::overload_cast<const std::string&, const std::function<void(Korali::Sample&)>>(&Korali::KoraliJsonWrapper::setItem), pybind11::return_value_policy::reference)
