...
Korali::Distribution::MultivariateNormal::~MultivariateNormal()
{
 gsl_rng_free(_range);
}

void Korali::Distribution::MultivariateNormal::getDensityVector(double *x, double* result, size_t n)
{
...
void Korali::Distribution::MultivariateNormal::getLogDensityVector(double *x, double* result, size_t n)
{
 gsl_vector_view _input_view = gsl_vector_view_array(x, n);
...
void Korali::Distribution::MultivariateNormal::getRandomVector(double *x, size_t n)
{
...
void Korali::Distribution::MultivariateNormal::updateDistribution()
{
...
void Korali::Distribution::MultivariateNormal::setProperty(std::string propertyName, std::vector<double> values)
{
