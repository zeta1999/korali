...
void DE::initInternals(size_t numsamplesmu)
{
...
void DE::updateConstraints() //TODO: maybe parallelize constraint evaluations (DW)
{
...
void DE::reEvaluateConstraints() //TODO: maybe we can parallelize constraint evaluations (DW)
{
  maxnumviolations = 0;
...
void DE::updateViabilityBoundaries()
{
 for(size_t c = 0; c < _numConstraints; ++c)
 {
  double maxviolation = 0.0;
...
void DE::sampleSingle(size_t sampleIdx)
{
...
void DE::updateDistribution(const double *fitnessVector)
{
...
void DE::updateEigensystem(double **M, int flgforce)
{
...
void DE::eigen(size_t size, double **M, double *diag, double **Q) const
{
...
void DE::sort_index(const double *fitnessVector, size_t *index, size_t n) const
{
...
double DE::doubleRangeMax(const double *rgd, size_t len) const
{
 double max = rgd[0];
 for (size_t i = 1; i < len; i++)
...
double DE::doubleRangeMin(const double *rgd, size_t len) const
{
 double min = rgd[0];
 for (size_t i = 1; i < len; i++)
