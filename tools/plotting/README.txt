...
# description: loops over all files/generations in resultsdir and plots
                evolution of cma-es optimizer

# parameter:
    resultsdir:  relative path to the folder containing all result files

# example1 (from console):
    python `korali-config --prefix`/bin/plot_cmaes.py korali1/
