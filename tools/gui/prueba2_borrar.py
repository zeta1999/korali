...
##q = webview.create_window('KORALI', 'https://pywebview.flowrl.com/hello')
##q.geometry('100x200')
##webview.start()



w = webview.create_window('KORALI','https://www.cse-lab.ethz.ch/korali/docs/tutorials/basic/2.sampling.html')
webview.start(w)
