...
#Creating experiment list
                           ...
                           for i in range(8) : e = korali.Experiment()

                                            e["Problem"]["Type"] = "Optimization/Stochastic" e["Problem"]["Objective Function"] = model

                                          e["Solver"]["Type"] = "CMAES" e["Solver"]["Population Size"] = 5 e["Solver"]["Termination Criteria"]["Max Generations"] = 25
                                          ...
                                          e["File Output"]["Path"] = '_result_run-multiple/exp' + str(i)
                                            e["Console Output"]["Frequency"] = 10 eList.append(e)
                                                                                ...
                                                                                print('------------------------------------------------------')
                                                                                  print('Now running last 25 generations...')
                                                                                    print('------------------------------------------------------')
                                                                                      ...
                                                                                      for e in eList : e["Solver"]["Termination Criteria"]["Max Generations"] = 50 k.resume(eList)
