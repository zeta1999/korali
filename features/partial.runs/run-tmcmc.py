...
import sys sys.path.append('./model')
                           ...
                           import korali k = korali.Engine()
                                                             e = korali.Experiment()
                                                               ...
                                                               e["Problem"]["Type"] = "Bayesian/Custom" e["Problem"]["Likelihood Model"] = calculateLogLikelihood

                                                           e["Solver"]["Type"] = "TMCMC" e["Solver"]["Population Size"] = 5000 e["Solver"]["Termination Criteria"]["Max Generations"] = 4

                                                           e["Distributions"][0]["Name"] = "Uniform 0" e["Distributions"][0]["Type"] = "Univariate/Uniform" e["Distributions"][0]["Minimum"] = - 100.0 e["Distributions"][0]["Maximum"] = + 100.0
                                                                         ...
                                                                         print("\n-------------------------------------------------------------")
                                                                           print("Running last generations...")
                                                                             print("-------------------------------------------------------------\n")
                                                                               ...
                                                                               e["Solver"]["Termination Criteria"]["Max Generations"] = 10 k.resume(e)
