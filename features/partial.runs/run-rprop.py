...
import sys sys.path.append('model')
                           ...
                           import korali k = korali.Engine()
                                                             e = korali.Experiment()
                                                               ...
                                                               e["Problem"]["Type"] = "Optimization/Gradient" e["Problem"]["Objective Function"] = model_with_gradient

                                                           e["Solver"]["Type"] = "Rprop" e["Solver"]["Termination Criteria"]["Max Generations"] = 25 e["Solver"]["Termination Criteria"]['Parameter Relative Tolerance'] = 1e-8

                                                           e["Variables"][0]["Name"] = "X" e["Variables"][0]["Initial Value"] = - 10.
                                                                         ...
                                                                         print("\n-------------------------------------------------------------")
                                                                           print("Running last 25 generations...")
                                                                             print("-------------------------------------------------------------\n")
                                                                               ...
                                                                               e["Solver"]["Termination Criteria"]["Max Generations"] = 50 k.resume(e)
