...
import sys sys.path.append('model')
                           ...
                           k = korali.Engine()
                                             ...
                                             e["Solver"]["Type"] = "CMAES" e["Solver"]["Population Size"] = 5 e["Solver"]["Termination Criteria"]["Max Generations"] = 5
...
#If found, we continue with the next 5 generations.
                                                                                  if (found == True) : print('------------------------------------------------------')
                                                                                    print('Running 5 more generations from previous run...')
                                                                                      print('------------------------------------------------------')
                                                                                        e["Solver"]["Termination Criteria"]["Max Generations"] = e["Solver"]["Termination Criteria"]["Max Generations"] + 5 k.resume(e)
