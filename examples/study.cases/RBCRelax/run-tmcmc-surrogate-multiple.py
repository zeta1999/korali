...
eList[0]["Problem"]["Computational Model"] = lambda sample: relaxModel_surrogate(sample, getReferencePoints('hochmuth01'), 'hochmuth01', 0.4 )
eList[1]["Problem"]["Computational Model"] = lambda sample: relaxModel_surrogate(sample, getReferencePoints('hochmuth02'), 'hochmuth02', 0.4 )
eList[2]["Problem"]["Computational Model"] = lambda sample: relaxModel_surrogate(sample, getReferencePoints('hochmuth03'), 'hochmuth03', 0.4 )
eList[3]["Problem"]["Computational Model"] = lambda sample: relaxModel_surrogate(sample, getReferencePoints('hochmuth04'), 'hochmuth04', 0.4 )
eList[4]["Problem"]["Computational Model"] = lambda sample: relaxModel_surrogate(sample, getReferencePoints('henon'), 'henon', 0.4 )
